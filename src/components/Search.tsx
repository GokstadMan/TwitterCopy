    ...
    return (
        <div className="flex flex-col p-4 gap-4">
            <div className="flex gap-2">
                <input value={searchData} onChange={(e) => setSearchData(e.target.value)} className="bg-gray-200 w-full py-2 px-4 rounded-full outline-none" placeholder="Search for users" type="text" />
