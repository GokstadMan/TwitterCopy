...
export default function Navigation () {
    ...
    return(
        <nav className="p-8 flex flex-col gap-6">
            ...
            <Link href="/app/notifications" className="text-xl font-semibold hover:underline">Notifications ({unreadNotifications.isSuccess ? unreadNotifications.data.Notifications: 0})</Link>
